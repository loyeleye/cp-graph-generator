...
import stylesCss from 'themes/cp-graph-generator/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_cp-graph-generator_componentCss']) {
    
    document['_vaadintheme_cp-graph-generator_componentCss'] = true;
  }
